...
namespace ArchaeaMod.Projectiles
{
    public class magno_javelinprojectile : ModProjectile
    {
            ...
            ref int hitDirection)
        {
            ...
            target.AddBuff(mod.BuffType<Buffs.dot>(), 900); // Adds the ExampleJavelin debuff for a very small DoT
        ...
        {
            int glowMask = Projectile.NewProjectile(projectile.position, projectile.velocity, mod.ProjectileType<magno_javelinglow>(), 0, 0f, projectile.owner, projectile.whoAmI, 0f);
        }
        bool init = false;
        int glowMask;
        ...
        {
            get { return mod.GetTexture("Gores/magno_javelinglow"); }
        }
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
        //  spriteBatch.Draw(texture,
        //      projectile.Center - Main.screenPosition, null,
        //      Color.White, projectile.rotation, new Vector2(projectile.width / 2, projectile.height / 2), 1f, SpriteEffects.None, 0f);
        }
    }
}